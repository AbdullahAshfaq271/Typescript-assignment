...
console.log(
  `The addition of two numbers that makes Number 8 is: 6 + 2 = `,
  6 + 2
);
console.log(
  `The subtraction of two numbers that makes Number 8 is: 10 - 2 = `,
  10 - 2
);
console.log(
  `The multiplication of two numbers that makes Number 8 is: 4 * 2 = `,
  4 * 2
);
console.log(
  `The division of two numbers that makes Number 8 is: 16 / 2 = `,
  16 / 2
);
...
console.log(
  `The multiplication of two numbers that makes Number 8 is: 4 * 2 = `,
  4 * 2
); // This program is for multiplication of two numbers that makes 8.
...
console.log(
  `The Kawasaki Ninja H2®R is the world's most powerful supercharged hypersport closed-course ${modeOfTransport[0]}.`
);
console.log(
  `The Toyota Supra is a sports ${modeOfTransport[1]} and grand tourer manufactured by the Toyota Motor Corporation beginning in 1978.`
);
...
console.log(
  `Hello! Total ${guestList.length} number of people you are invited to dinner`
);
...
if (alien_color === "green") {
  console.log(
    `Player: ${p1} has earned 5 points for shooting the green alien.`
  );
} else if (alien_color === "yellow") {
  console.log(
    `Player: ${p1} has  earned 10 points for shooting the yellow alien.`
  );
...
for (let i = 0; i < new_users.length; i++) {
  var isNameTaken = current_users.some(
    (current_users) =>
      current_users.toLowerCase() === new_users[i].toLowerCase()
  );
  if (isNameTaken) {
    console.log(
      `"${new_users[i]}" has been used."${new_users[i]}" should not be accepted`
    );
  } else {
...
console.log(
  `They're all obligate carnivores, and the majority of them are lone predators who ambush or stalk their prey.`
);
...
function make_shirt(size: any, message: string) {
  console.log(
    `Your shirt size is: "${size}" and the message written on it is: "${message}"`
  );
}
